let data = [
  ...
  "",
  "I'm currently focusing fully on React native building the next generation food delivery platform mobile app.",
  "",
  "I also develop full stack applications usisng the MERN Stack",
  "",
